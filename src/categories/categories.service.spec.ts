...
describe('CategoriesService', () => {
  ...
  describe('create', () => {
    it('should create a category successfully', async () => {
      ...
      const expectedCategory = { id: 1, ...createDto };
  ...
  describe('findOne', () => {
    ...
    it('should throw a NotFoundException if category not found', async () => {
      ...
      await expect(service.findOne(1)).rejects.toThrow(new NotFoundException('Category #1 not found'));
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw a NotFoundException if category to update is not found', async () => {
        ...
        await expect(service.update(categoryId, updateDto)).rejects.toThrow(new NotFoundException(`Category #${categoryId} not found`));
      });
  });
  ...
  describe('remove', () => {
    ...
    it('should throw a NotFoundException if category to remove is not found', async () => {
        ...
        await expect(service.remove(1)).rejects.toThrow(new NotFoundException('Category #1 not found'));
    });
  });
});