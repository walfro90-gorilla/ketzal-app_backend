...
describe('WalletService', () => {
  ...
  describe('getOrCreateWallet', () => {
    ...
    it('should create a new wallet with a welcome bonus if one does not exist', async () => {
        const newWallet = { ...mockWallet, balanceAxo: 50 };
        (prisma.users.findUnique as jest.Mock).mockResolvedValue(mockUser);
        ...
        // Check that wallet creation was called with the correct data (excluding auto-generated fields)
        ...
        // Check that transaction creation was called with the correct data (excluding auto-generated fields)
  ...
  describe('addFunds', () => {
    it('should add only MXN funds to an existing wallet', async () => {
      ...
      // Check that wallet update was called with the correct data (excluding auto-generated fields)
  ...
  describe('transferFunds', () => {
    ...
    it('should create a wallet for the recipient if it does not exist during transfer', async () => {
        const recipientWithoutWallet = { ...mockRecipientUser };
        ...
        (prisma.wallet.findUnique as jest.Mock).mockResolvedValue(mockWallet);
        (prisma.wallet.findUnique as jest.Mock).mockResolvedValueOnce(mockWallet).mockResolvedValueOnce(null); // First call for sender, second for recipient
