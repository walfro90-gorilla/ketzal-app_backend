...
import { GlobalLocationsModule } from '../src/locations/global-locations.module';
...
export default async function handler(req, res) {
  ...
  // but only with the GlobalLocationsModule.
  const app = await NestFactory.create(GlobalLocationsModule, {
