...
describe('ServicesService', () => {
    ...
    describe('create', () => {
        it('should create a service', async () => {
            ...
            prisma.services.create.mockResolvedValue(mockService);
    ...
    describe('findAll', () => {
        it('should return an array of services', async () => {
            prisma.services.findMany.mockResolvedValue([mockService]);
    ...
    describe('findAllWithAverageRating', () => {
        it('should return services with average rating', async () => {
            prisma.services.findMany.mockResolvedValue([mockService]);
            prisma.reviews.findMany.mockResolvedValue([{ rating: 5 }, { rating: 3 }]);
    ...
    describe('findOne', () => {
        it('should return a single service', async () => {
            prisma.services.findUnique.mockResolvedValue(mockService);
    ...
    describe('update', () => {
        it('should update a service', async () => {
            ...
            prisma.services.update.mockResolvedValue(Object.assign(Object.assign({}, mockService), updateDto));
        ...
        it('should throw NotFoundException if service to update is not found', async () => {
            prisma.services.update.mockResolvedValue(null);
    ...
    describe('remove', () => {
        it('should remove a service if it has no reviews', async () => {
            prisma.services.findUnique.mockResolvedValue(mockService);
            prisma.reviews.findMany.mockResolvedValue([]);
            prisma.services.delete.mockResolvedValue(mockService);
        ...
        it('should throw an error if service has reviews', async () => {
            prisma.services.findUnique.mockResolvedValue(mockService);
            prisma.reviews.findMany.mockResolvedValue([{ id: 1, rating: 5 }]);
    ...
    describe('search', () => {
        it('should search services by keyword, location, and dates', async () => {
            ...
            prisma.services.findMany.mockResolvedValue(services);
        ...
        it('should handle search with no results', async () => {
            const services = [];
            prisma.services.findMany.mockResolvedValue(services);
            prisma.services.count.mockResolvedValue(0);
            const result = await service.search('Test', 'Location', new Date(), new Date(), 1, 10);
